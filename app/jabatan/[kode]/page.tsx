...
export default async function ViewJabatanPage({
  params,
}: {
  ...
  const rows = [
    ...
    { label: "Gaji", value: `Rp ${Number(data.gaji).toLocaleString("id-ID")}` },
  ];
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <Card>
            <CardHeader className="border-b bg-muted/30 flex flex-row items-center gap-4">
              ...
              <div>
                <CardTitle className="text-xl">Detail Jabatan</CardTitle>
                <p className="text-sm text-muted-foreground">{data.kodeJabatan}</p>
              </div>
            </CardHeader>
